...
_integrators_classes = {"symplectic": SymplecticIntegrator, "rk4": RungeKutta4Integrator}


def integrator(
    hamiltonian, q_symbols, p_symbols, parameter_subs=None, itype="symplectic", order=1
):
    """
